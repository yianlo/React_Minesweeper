...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyComponent = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(Game, { initBombCount: 50 });
	  }
	});
...
/***/ function(module, exports) {
	...
	Tile.prototype.toggleClick = function () {
	  this.clicked = true;
	};
	...
	Board.prototype.toggleBombsToFlags = function () {
	  this.grid.forEach(function (row) {
	    row.forEach(function (tile) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    FlagCounter = __webpack_require__(163),
	    Timer = __webpack_require__(165);
	...
	var Game = React.createClass({
	  ...
	  updateGame: function (tile, flagging) {
	    if (this.state.new) {
	      this.setState({ running: true, new: false });
	    }
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'nav',
	        null,
	        React.createElement(FlagCounter, { flagCount: this.state.flagCount }),
	        React.createElement(
	          'div',
	          { className: 'reset-button', onClick: this.resetGame },
	          this.state.buttonFace
	        ),
	        React.createElement(Timer, { running: this.state.running, 'new': this.state.new })
	      ),
	...
	var FlagCounter = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'section',
	      { className: 'timer' },
	      this.numDisplay(this.props.flagCount)
	    );
	  }
	});
